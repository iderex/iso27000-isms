...
`templates/registers/asset-register` und `templates/soa`. Unter
`presentations`, `trainings` und `mappings` liegt zu diesem Thema heute nichts,
und das ist keine Aufforderung, etwas zu erfinden.
